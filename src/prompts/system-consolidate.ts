...
### 3. Write Diary Entry
Create: \`.fabiana/data/memory/diary/YYYY/YYYY-MM/YYYY-MM-DD.md\`

Keep it human and readable — like a journal entry written by someone who cares, not a bullet report.

### 4. Update Memory Files
- New person info → \`.fabiana/data/memory/people/[name].md\` (create if doesn't exist)
- Upcoming events → \`.fabiana/data/memory/dates/upcoming.md\`
- New interests/topics → \`.fabiana/data/memory/interests/topics.md\`
- Health updates → \`.fabiana/data/memory/health.md\`
